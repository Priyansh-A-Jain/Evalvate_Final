        ...
        <article className="rounded-2xl border border-[var(--border-default)] bg-white/85 p-6 shadow-sm">
          ...
          {latestSnapshot ? (
            <div className="mt-4 space-y-3 text-sm text-[var(--text-secondary)]">
              <Link
                href={`/interview/analysis?id=${latestSnapshot.session_id}`}
                className="inline-flex items-center gap-2 rounded-lg bg-[var(--accent-secondary)]/10 px-3 py-2 text-sm font-semibold text-[var(--accent-secondary)] transition hover:bg-[var(--accent-secondary)]/15"
              >
                Open Full Report
                <ArrowRight className="h-4 w-4" />
              </Link>
